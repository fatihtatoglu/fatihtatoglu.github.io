...
description: "A personal reflection on working with AI-learning, experimenting, and contributing as an individual without training models or chasing big breakthroughs."
keywords:
  - working with artificial intelligence
  - individual contribution in ai
  - learning ai
  - large language model
  - experimental learning
featured: true
cover: /assets/images/finding-my-place-in-the-age-of-ai.webp
coverAlt: "A symbolic relationship between an engineer and two artificial intelligence figures"
coverCaption: "Working with AI is sometimes less about training models and more about knowing where you stand."
template: post
layout: default
status: published
...
First of all, _"working with artificial intelligence"_ does not only mean training models, fine-tuning them, or optimizing an existing algorithm.

In my opinion, these are the hardest, most valuable, and most scientific parts of AI. Still, there are many areas where you can honestly say, _"I work with AI."_
...
Similarly, without platforms like [Stack Overflow](https://stackoverflow.com) and [GitHub](https://github.com) which I'm sure my developer friends follow the development approach known as Vibe Coding would not have progressed this fast.
...
Toward the end of 2025, a local LLM model called "Kumru" was released. I was incredibly happy. I imagine the people who developed "Kumru" felt the same justified pride as the engineers who worked on the _"Devrim"_ automobile. But the outcome was the same for both products. They were criticized much more harshly than they deserved, and people shared AI-generated memes just to make themselves look funny.
...
- [The Intelligence of the Future: Bias-Free Robots | Cem Say | TEDxIstanbul](https://www.youtube.com/watch?v=dCQtt3cA_VA) A talk by Cem Say on artificial intelligence.
- [Mathematics and Philosophy - 1+1=1 | 19.10.2021](https://www.youtube.com/watch?v=5IcL3v3nRsQ) A TV program with Ali Nesin and Dücane Cündioğlu.
- [Word2vec](https://en.wikipedia.org/wiki/Word2vec) An application developed by Tomáš Mikolov and his colleagues that represents words as vectors.
