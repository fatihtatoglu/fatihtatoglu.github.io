...
description: "Yapay zekâ çağında herkes model mi eğitmeli? Büyük atılımlar yerine bireysel öğrenme, üretim ve katkı yolları üzerine kişisel bir sorgulama."
keywords:
  - yapay zekâ ile uğraşmak
  - yapay zekâ çağında bireysel üretim
  - yapay zekâ öğrenme süreci
  - yapay zeka
  - bireysel üretim
  - large language model
  - öğrenme süreci
  ...
  - buyuk-dil-modeli
featured: true
cover: /assets/images/finding-my-place-in-the-age-of-ai.webp
coverAlt: Bir mühendis ve iki yapay zekâ figürü arasında kurulan sembolik ilişki
coverCaption: "Yapay zekâ ile uğraşmak bazen model eğitmekten çok, doğru yerde durabilmekir."
template: post
layout: default
status: published
---
...
İlk olarak; _"yapay zekâ ile uğraşmak"_, sadece model eğitmek, fine-tune etmek ya da var olan bir algoritmayı optimize etmek değildir.

Bu başlıklar yapay zekânın en zor, en değerli ve en bilimsel kısımları bana göre. Ama yine de _"yapay zekâ ile uğraşıyorum"_ denebilir bir sürü alan var.
...
Benzer şekilde, yazılımcı arkadaşlarımın takip ettiğine emin olduğum [Stack Overflow](https://stackoverflow.com) ve [GitHub](https://github.com) olmasaydı, Vibe Coding ismi verilen geliştirme yöntemi bu kadar hızlı ilerlemeyecekti.
...
2025 yılının sonlarına doğru "Kumru" adında bir yerli LLM modeli çıktı. Ben acayip mutlu oldum. Tıpkı _"Devrim"_ otomobilinin üretiminde çalışan mühendislerin yaşadığı haklı gururunu yaşadıklarını düşünüyorum "Kumru"yu geliştirenlerin. Ama iki ürün için de sonuç aynı oldu. Hak ettiğinden daha sert eleştirildi; sadece kendilerini daha komik göstermek için yapay zekâ ile üretilmiş caps'ler paylaştılar.
...
- [Duygu Çakır](https://www.linkedin.com/in/duygu-cakir-45483164)
- [Alican Kiraz](https://www.linkedin.com/in/alican-kiraz)
- [M. Ali Bayram](https://www.linkedin.com/in/mehmetalibayram)
- [Mert Yeter](https://www.linkedin.com/in/mertyeter)
- [Ceren Kaya Akgün](https://medium.com/@cerenkaya07)
- [Mehmet Burak Akgün](https://www.linkedin.com/in/mbakgun)
- [Upsonic](https://www.linkedin.com/company/getupsonic/)
- [Commencis](https://www.linkedin.com/company/commencis/)
- [oNabu](https://www.linkedin.com/company/onabu-ai/)
- [Andrej Karpathy](https://youtube.com/@andrejkarpathy?si=EqmQCUJyE0KExIEm)

### Okuma Kaynakları

- [Geleceğin Zekâsı: Önyargısız Robotlar | Cem Say | TEDxIstanbul](https://www.youtube.com/watch?v=dCQtt3cA_VA) - Cem Say'ın Yapay Zekâ hakkında yaptığı konuşma.
- [Matematik ve Felsefe - 1+1=1 | 19.10.2021](https://www.youtube.com/watch?v=5IcL3v3nRsQ) Ali Nesin ve Dücane Cündioğlu'nun katıldığı televizyon programı.
- [Word2vec](https://en.wikipedia.org/wiki/Word2vec) Tomáš Mikolov ve arkadaşlarının geliştirdiği kelimeleri vektör olarak gösterilmesini sağlayan uygulama.
